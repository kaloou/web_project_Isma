...
!(function (e, t) {
  ...
  function h(e) {
    return (
      e.querySelector(".swiper-slide-transform") || (e.shadowEl && e.shadowEl.querySelector(".swiper-slide-transform")) || e
    );
  }
  function f(e, t) {
  ...
  var G = {
    ...
    slideToLoop: function (e, t, s, a) {
      if (
        (void 0 === e && (e = 0), void 0 === t && (t = this.params.speed), void 0 === s && (s = !0), "string" == typeof e)
      ) {
        e = parseInt(e, 10);
      }
      const i = this;
  ...
  function X(e) {
    ...
    let x = !0;
    u.matches(n.focusableElements) && ((x = !1), "SELECT" === u.nodeName && (n.isTouched = !1)),
  ...
  const pe = [
    function (e) {
      ...
      function c(e) {
        ...
        if (
          (r && g >= b ? ((y -= b), i || (E += s.slidesGrid[0])) : r && g < b && ((y = -b), i && (E += s.slidesGrid[0])),
    ...
    function (e) {
      ...
      function d() {
        return (
          !t.params.pagination.el || !t.pagination.el || (Array.isArray(t.pagination.el) && 0 === t.pagination.el.length)
        );
      }
      function c(e, s) {
      ...
      const y = () => {
        ...
        M = () => {
          (i.isEnd && d < 0 && !i.params.loop) ||
            i.destroyed ||
            !i.autoplay.running ||
            ((w = new Date().getTime()), f ? ((f = !1), x(d)) : x(), (i.autoplay.paused = !1), l("autoplayResume"));
        },
        C = () => {
          if (i.destroyed || !i.autoplay.running) return;
          const e = a();
